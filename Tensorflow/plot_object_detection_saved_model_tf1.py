...
def download_images():
    base_url = 'https://cdn.jsdelivr.net/gh/chewzzz1014/tensorflow-learning/Tensorflow/examples/'
...
def download_labels(filename):
    base_url = 'https://cdn.jsdelivr.net/gh/chewzzz1014/tensorflow-learning/Tensorflow/workspace/training_demo/annotations/'
